...
rm -rf ./output
mv -f ./source/mapbox-android/com.mapbox.mapboxsdk.mapbox-android-plugin-annotation/bin/Release/net8.0-android/ ./output
mv -f ./source/mapbox-android/com.mapbox.mapboxsdk.mapbox-android-plugin-building/bin/Release/net8.0-android/com.mapbox.mapboxsdk.mapbox_android_plugin_building.* ./output
mv -f ./source/mapbox-android/com.mapbox.mapboxsdk.mapbox-android-plugin-traffic/bin/Release/net8.0-android/com.mapbox.mapboxsdk.mapbox_android_plugin_traffic.* ./output
